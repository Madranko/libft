...
#    Updated: 2017/11/16 15:56:26 by mmotov           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c ft_lstiter.c \
		ft_lstmap.c ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c \
		...
		ft_tolower.c ft_toupper.c ft_isupper.c ft_islower.c \
		ft_swap.c ft_lstprint.c ft_lstsize.c
OBJ = $(SRC:.c=.o)
